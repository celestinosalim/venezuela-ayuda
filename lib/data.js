...
export const T = {
  es: {
    ...
    entregar: ["📦 Entregar donaciones en persona", "Puntos reales de acopio (Doral, FL y Bogotá), confirmados con fuentes oficiales el 26 jun. Toca «Mapa» para ir; «fuente» abre el anuncio oficial. Enlaces revisados cada hora."],
    entregarMore: "Ver más puntos en todo Miami-Dade →",
    entregarMoreUrl: "https://wsvn.com/news/local/miami-dade/drop-off-locations-across-miami-dade-for-venezuela-earthquake-relief-drive/",
    source: "fuente",
  ...
  en: {
    ...
    entregar: ["📦 Drop off donations in person", "Real collection points (Doral, FL and Bogotá), confirmed against official sources on Jun 26. Tap \"Map\" to go; \"source\" opens the official announcement. Links re-checked hourly."],
    entregarMore: "See more points across Miami-Dade →",
    entregarMoreUrl: "https://wsvn.com/news/local/miami-dade/drop-off-locations-across-miami-dade-for-venezuela-earthquake-relief-drive/",
    source: "source",
