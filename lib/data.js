...
export const T = {
  es: {
    ...
    entregar: ["📦 Entregar donaciones en persona", "Puntos reales de acopio en Florida (Doral, Sweetwater, Broward, Orlando) y Bogotá, confirmados con fuentes el 26 jun. Toca «Mapa» para ir; «fuente» abre el anuncio oficial. Algunos son temporales — confirma horarios. Enlaces revisados cada hora."],
  ...
  en: {
    ...
    entregar: ["📦 Drop off donations in person", "Real collection points in Florida (Doral, Sweetwater, Broward, Orlando) and Bogotá, confirmed against sources on Jun 26. Tap \"Map\" to go; \"source\" opens the official announcement. Some are temporary — check hours. Links re-checked hourly."],
