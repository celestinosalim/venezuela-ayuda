// Verified, aggregated from news + official sources. Updated 2026-06-27.
...
export const T = {
  es: {
    ...
    quakeContext: "Al 27 jun: más de 1.400 fallecidos confirmados y decenas de miles de desaparecidos reportados; más de 400 réplicas. Las cifras cambian — ver «Info oficial».",
    ...
    ninos: ["🧒 Donar a los niños", "Unos 3,9 millones de niños viven en las zonas afectadas (estimación UNICEF, 25 jun). Organizaciones especializadas en la niñez:"],
    entregar: ["📦 Entregar donaciones en persona", "Puntos reales de acopio en Florida (Doral, Sweetwater, Broward, Orlando, Tampa, Miami) y Bogotá, confirmados con fuentes el 27 jun. Toca «Mapa» para ir; «fuente» abre el anuncio oficial. Algunos son temporales — confirma horarios y fechas de cierre. Enlaces revisados cada hora."],
  ...
  en: {
    ...
    quakeContext: "As of Jun 27: 1,400+ confirmed dead and tens of thousands reported missing; 400+ aftershocks. Figures change — see \"Official info\".",
    ...
    ninos: ["🧒 Donate for children", "About 3.9 million children live in the affected areas (UNICEF estimate, Jun 25). Organizations specialized in children:"],
    entregar: ["📦 Drop off donations in person", "Real collection points in Florida (Doral, Sweetwater, Broward, Orlando, Tampa, Miami) and Bogotá, confirmed against sources on Jun 27. Tap \"Map\" to go; \"source\" opens the official announcement. Some are temporary — check hours and closing dates. Links re-checked hourly."],
